...
```bash
# Output to stdout
python3 scripts/generate_release_notes.py 0.2.0

# Output to file
python3 scripts/generate_release_notes.py 0.2.0 release_notes.md
```
...
# Test output to file
python3 scripts/generate_release_notes.py 0.2.0 /tmp/test_notes.md
...
**Usage:**
```bash
# Test with default version (0.2.0)
bash scripts/test_release_notes.sh

# Test with specific version
bash scripts/test_release_notes.sh 0.2.0
```
