...
class Serializable:
    ...
    def serialize(self, max_depth: int = ..., _current_depth: int = ...) -> Dict[str, Any]: ...
    def deserialize(
...
class ObjectRegistry:
    ...
    def clear(self) -> None: ...
    def register_custom_lookup(self, class_name: str, lookup_func: Callable[..., Any]) -> None: ...

def register_serializable(cls: Optional[type] = ...) -> Union[Callable[[type], type], type]: ...
def check_serializable_constructability(obj: Any) -> bool: ...
def validate_serializable_tree(obj: Any, visited: Optional[set] = ...) -> bool: ...
